    ...
    return (
        <div className="product-item">
            ...
            <div className="product-details">
                ...
                <div className="product-price text-16px">가격: {productPrice}원</div>
...
const NormalProductPresenter = ({products}) => {
   return (
           <div className="home-page-container">
               <div className="home-content-layout">                
                   <main className="home-main-content">
                       <section className="product-section">
                           <h2 className="section-title text-46px">중고상품</h2>
...
export default  NormalProductPresenter;